...
```
cd existing_repo
git remote add origin https://gitlab-stud.elka.pw.edu.pl/proi.23l-projekty/209.3-ramie-robota.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-stud.elka.pw.edu.pl/proi.23l-projekty/209.3-ramie-robota/-/settings/integrations)
